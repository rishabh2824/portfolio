...
// dialog body. Kept deliberately light (no icon sets, no SlideShow/embla)
// since this loads eagerly for every visitor via sections/projects.tsx. The
// modal body (skills + write-up) lives in project-details.tsx and is fetched
// on first open — see BentoTile.
export type Project = {
  id: ProjectId;
  category: string;
  title: string;
  src: string;
  // Optional: internal/client-owned work (e.g. Iris) has no public URL, and a
  // project with neither `live` nor `github` simply renders no link row.
  live?: string;
  github?: string;
};
...
const projects: Project[] = [
  {
    ...
    src: "/assets/projects-screenshots/solarRacing/landing.webp",
  ...
  },
  {
    ...
    title: "ai-horizon.io",
    src: "/assets/projects-screenshots/aihorizon/landing.webp",
  ...
  },
  {
    ...
    title: "Iris",
    src: "/assets/projects-screenshots/iris/1.webp",
    // Internal tool built for DataCEVA — no public URL to link to.
  },
  {
    id: "wisconsincaselab",
    category: "Interactive Case Studies",
    title: "WisconsinCaseLab",
    src: "/assets/projects-screenshots/wisconsincaselab/1.webp",
